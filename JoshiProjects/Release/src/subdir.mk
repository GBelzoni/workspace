...
src/%.o: ../src/%.cpp
	...
	g++ -I"/home/phcostello/Documents/workspace/JoshiLibrary" -I"/home/phcostello/CppCode/Code from books/C++Design_Joshi/include" -O3 -Wall -c -fmessage-length=0 -fPIC -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
